...
MAX_ALLOWED_RADIUS_SENSOR = 15.0
QUALIFIER_SENSORS_LIMITS = {
    'sensor.camera.rgb': 8,
    'sensor.lidar.ray_cast': 1,
    'sensor.other.radar': 2,
    'sensor.other.gnss': 2, #1,
    'sensor.other.imu': 2, #1,
    'sensor.opendrive_map': 1,
    'sensor.speedometer': 2, #1,
    'sensor.camera.depth': 7, # for data generation
    'sensor.camera.semantic_segmentation': 7 # for data generation
}
SENSORS_LIMITS = {
    'sensor.camera.rgb': 13,
