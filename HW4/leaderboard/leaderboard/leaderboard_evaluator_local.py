...
class LeaderboardEvaluator(object):
    ...
    def _load_and_run_scenario(self, args, config):
        ...
        scenario_name = f"{config.scenario_configs[0].type}_{config.name}"
        ...
        try:
            ...
            self.agent_instance.setup(args.agent_config, route_date_string, self.traffic_manager, scenario_name)
