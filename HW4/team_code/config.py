...
class GlobalConfig:
    ...
    def __init__(self):
        ...
        # from bench2Drive ( surrounded cameras )
        self.cam_front_pos = [0.8, 0.0, 1.6] # x, y, z mounting position of the front camera
        self.cam_front_left_pos = [0.27, -0.55, 1.6] # x, y, z mounting position of the front camera
        self.cam_front_right_pos = [0.27, 0.55, 1.6] # x, y, z mounting position of the rear camera
        self.cam_back_pos = [-2.0, 0.0, 1.6] # x, y, z mounting position of the front camera
        self.cam_back_left_pos = [-0.32, -0.55, 1.6] # x, y, z mounting position of the front camera
        self.cam_back_right_pos = [-0.32, 0.55, 1.6] # x, y, z mounting position of the front camera
        
        self.cam_front_rot  = [0.0, 0.0, 0.0]  # Roll Pitch Yaw of camera 0 in degree
        self.cam_front_left_rot   = [0.0, 0.0, -55.0]  # Roll Pitch Yaw of camera 0 in degree
        self.cam_front_right_rot  = [0.0, 0.0, 55.0]  # Roll Pitch Yaw of camera 0 in degree
        self.cam_back_rot   = [0.0, 0.0, 180.0]  # Roll Pitch Yaw of camera 0 in degree
        self.cam_back_left_rot   = [0.0, 0.0, -110.0]  # Roll Pitch Yaw of camera 0 in degree
        self.cam_back_right_rot   = [0.0, 0.0, 110.0]  # Roll Pitch Yaw of camera 0 in degree
        
        self.cam_width = 800 # 1600
        self.cam_height = 450 # 900
        
        self.cam_fov = 90 #70 ?? to solve fov 70 can not see traffic light problem 

        self.cam_back_fov = 110 # only cam back use this fov (110 degree)
