...
_C.PRETRAINED.LOAD_OPT = False
_C.PRETRAINED.FREEZE = False
_C.PRETRAINED.PATH = ''
...
_C.IMAGE.CROP_SIZE = -1
_C.IMAGE.TOP_CROP = 46
_C.IMAGE.ORIGINAL_HEIGHT = 450  # Original input RGB camera height
_C.IMAGE.ORIGINAL_WIDTH = 800  # Original input RGB camera width
_C.IMAGE.NAMES = ['CAM_FRONT_LEFT', 'CAM_FRONT', 'CAM_FRONT_RIGHT', 'CAM_REAR_LEFT', 'CAM_REAR', 'CAM_REAR_RIGHT']
...
_C.SEMANTIC_SEG.OBSTACLE = CN()
_C.SEMANTIC_SEG.OBSTACLE.ENABLED = False
_C.SEMANTIC_SEG.OBSTACLE.WEIGHTS = [1.0, 4.0]
_C.SEMANTIC_SEG.OBSTACLE.USE_TOP_K = True  # backprop only top-k hardest pixels
_C.SEMANTIC_SEG.OBSTACLE.TOP_K_RATIO = 0.25
...
_C.SEMANTIC_SEG.SUBGOAL = CN()
_C.SEMANTIC_SEG.SUBGOAL.ENABLED = False
_C.SEMANTIC_SEG.SUBGOAL.WEIGHTS = [1.0, 10.0]
_C.SEMANTIC_SEG.SUBGOAL.USE_TOP_K = True
_C.SEMANTIC_SEG.SUBGOAL.TOP_K_RATIO = 0.25
...
_C.SEMANTIC_SEG.LANE = CN()
_C.SEMANTIC_SEG.LANE.ENABLED = False
_C.SEMANTIC_SEG.LANE.WEIGHTS = [1.0, 2.0]
# _C.SEMANTIC_SEG.LANE.WEIGHTS = [1.0, 4.0]
_C.SEMANTIC_SEG.LANE.USE_TOP_K = True
_C.SEMANTIC_SEG.LANE.TOP_K_RATIO = 0.25

_C.SEMANTIC_SEG.AREA = CN()
_C.SEMANTIC_SEG.AREA.ENABLED = True
_C.SEMANTIC_SEG.AREA.WEIGHTS = [1.0, 1.0]
_C.SEMANTIC_SEG.AREA.USE_TOP_K = False
_C.SEMANTIC_SEG.AREA.TOP_K_RATIO = 0.25

_C.SEMANTIC_SEG.STOP = CN()
_C.SEMANTIC_SEG.STOP.ENABLED = False
_C.SEMANTIC_SEG.STOP.WEIGHTS = [1.0, 10.0]
_C.SEMANTIC_SEG.STOP.USE_TOP_K = True
_C.SEMANTIC_SEG.STOP.TOP_K_RATIO = 0.25

_C.SEMANTIC_SEG.TRAFFIC = CN()
_C.SEMANTIC_SEG.TRAFFIC.ENABLED = False
...
_C.PROBABILISTIC.GT_FUTURE = False  # learn a distribution over futures
