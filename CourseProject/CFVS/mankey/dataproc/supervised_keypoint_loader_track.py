...
from utils.imgproc import PixelCoord, get_guassian_heatmap, get_bbox_cropped_image_path
from dataproc.supervised_keypoint_db import SupervisedKeypointDBEntry, SupervisedImageKeypointDatabase
import attr
...
class SupervisedKeypointDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        from utils.imgproc import rgb_image_normalize, depth_image_normalize
    ...
    def _get_transformed_keypoint(
        ...
        from utils.imgproc import transform_2d, PixelCoord, pixel_in_bbox
...
def save_loaded_img():
    ...
    from dataproc.spartan_supervised_db import SpartanSupvervisedKeypointDBConfig, SpartanSupervisedKeypointDatabase
    ...
    from utils.imgproc import draw_image_keypoint, draw_visible_heatmap, get_visible_mask
