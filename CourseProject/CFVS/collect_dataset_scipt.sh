...
### square hole
#python collect_rollout_data_for_kovis.py --date 2022-09-16-test --iter 35 --data_type test --yaw --tilt
...
### ours
##python collect_coarse_insertion_data_nomove.py --hole square_7x12x12_squarehole --date 2022-09-16-test --iter 10
...
##python collect_fine_insertion_data.py --hole square_7x12x12_squarehole --date 2022-09-16-test --iter 10 --offset_angle 10
