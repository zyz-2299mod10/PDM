...
class CoarseMover(object):
    def __init__(self, model_path='kpts/2022-02-??_??-??', model_name='pointnet2_kpts', checkpoint_name='best_model_e_?.pth', use_cpu=False, out_channel=9):
        ...
        exp_dir = '/home/hcis/YongZhe/CFVS/mankey/log/' +  model_path
...
if __name__ == '__main__':
    add_noise = False
    use_offset = False
    model_path = '/kpts/2024-04-22_19-39'
    mover = CoarseMover(model_path=model_path, model_name='pointnet2_kpts',
                               checkpoint_name='best_model_e_324.pth', use_cpu=False, out_channel=9)
    ...
    data_root = '/home/hcis/YongZhe/CFVS_infer/processed'
