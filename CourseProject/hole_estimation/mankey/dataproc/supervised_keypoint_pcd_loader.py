...
from dataproc.supervised_keypoint_pcd_db import SupervisedKeypointDBEntry, SupervisedImageKeypointDatabase
import attr
...
class ProcessedEntry:
    ...
    # xyzrot
    hole_top_rotation = np.ndarray(shape=[]) ###
...
class SupervisedKeypointDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        return {
            ...
            parameter.hole_top_rotation: processed_entry.hole_top_rotation.astype(np.float32), ###
    ...
    def get_processed_entry(self, entry: SupervisedKeypointDBEntry) -> ProcessedEntry:
        ...
        # xyzrot
        processed_entry.hole_top_rotation = entry.hole_top_rotation
