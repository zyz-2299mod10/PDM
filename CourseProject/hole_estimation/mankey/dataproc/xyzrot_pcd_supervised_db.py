...
from utils.imgproc import PixelCoord, pixel_in_bbox
from utils.transformations import quaternion_matrix
from dataproc.supervised_keypoint_db import SupervisedImageKeypointDatabase, SupervisedKeypointDBEntry, sanity_check_spartan
...
class SpartanSupervisedKeypointDatabase(SupervisedImageKeypointDatabase):
    ...
    def _build_scene_entry(self, scene_root: str, keypoint_yaml_name: str) -> List[SupervisedKeypointDBEntry]:
        ...
        keypoint_yaml_map = yaml.load(keypoint_yaml_file, Loader=yaml.FullLoader)
    ...
    def _get_image_entry(self, image_map, scene_root: str) -> SupervisedKeypointDBEntry:
        ...
        '''
        # xyzrot
        entry.hole_top_rotation = np.array(image_map['hole_keypoint_obj_top_pose_in_world'])[:3, :3] ###
