...
def construct_dataset(is_train: bool) -> (torch.utils.data.Dataset, SupervisedKeypointDatasetConfig):
    ...
    # if is_train:
    #     db_config.config_file_path = '/tmp2/r09944001/robot-peg-in-hole-task/mankey/config/insertion_20220704_fine_test.txt'
    # else:
    #     db_config.config_file_path = '/tmp2/r09944001/robot-peg-in-hole-task/mankey/config/insertion_20220704_fine_test.txt'
    ...
    if is_train:
        ...
        db_config.config_file_path = '/home/hcis/YongZhe/PDM/CFVS/mankey/config/Square_fine.txt'
    else:
        # db_config.config_file_path = '/tmp2/r09944001/robot-peg-in-hole-task/mankey/config/insertion_20220616_coarse_noiseaug3_rotscale.txt'
        db_config.config_file_path = '/home/hcis/YongZhe/PDM/CFVS/mankey/config/Square_fine.txt'
    database = SpartanSupervisedKeypointDatabase(db_config)
...
def main(args):
    ...
    for epoch in range(start_epoch, args.epoch):
        ...
        writer.add_scalar('Training delta rotation loss', train_rot_error, epoch)
        writer.add_scalar('Training delta translation loss', train_xyz_error, epoch)
        ...
        with torch.no_grad():
            ...
            writer.add_scalar('testing delta rotation loss', rot_error, epoch)
            writer.add_scalar('testing delta translation loss', xyz_error, epoch)
