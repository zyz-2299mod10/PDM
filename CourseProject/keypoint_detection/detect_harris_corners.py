...
def plot_corners(img_clr, corners, save_img_path):
    ...
    for i in range(corners.shape[0]):
        cv2.circle(img_clr, (corners[i, 0], corners[i, 1]), radius=5, color=[0, 0, 255], thickness=-1)
...
def detect_corners(img, dest_img_path, nms_kernel_size, sigma, k=0.06, thresh=0.75, max_no_corners=-1):
    """
    ...
    if dest_img_path is not None:
        ...
        plot_corners(img, corners, dest_img_path)
...
if __name__ == "__main__":
    ...
    ##### pair ####
    imgs = ["/home/hcis/YongZhe/PDM/hand_0_rgb.png"]
    ...
    for img_path in imgs:
        ...
        lst_sigma = [0.9] #[0.5, 0.8, 0.9, 1.2, 2]
        # lst_sigma = [0.707]
        nms_kernel_size = 10
        k = 0.1
        thresh = 0.3
        ...
        for sigma in lst_sigma:
            ...
            detect_corners(img, dest_img_path, nms_kernel_size, sigma, k, thresh, max_no_corners)
