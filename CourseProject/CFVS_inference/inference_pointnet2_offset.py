...
from mankey.models.loss import RMSELoss
...
class FineMover(object):
    def __init__(self, model_path='kpts/2022-02-??_??-??', model_name='pointnet2_kpt_dir', checkpoint_name='best_model_e_?.pth', use_cpu=False, out_channel=9):
        '''MODEL LOADING'''
        exp_dir = os.path.join('/home/hcis/YongZhe/PDM/CFVS_inference/mankey/log', model_path)
...
if __name__ == '__main__':
    crop_pcd = False
    model_path = 'offset/2024-10-30_01-07'
    mover = FineMover(model_path=model_path, model_name='pointnet2_offset',
                               checkpoint_name='best_model_e_104.pth', use_cpu=False, out_channel=9)
    #data_root = '/home/luben/data/pdc/logs_proto/2022-02-26-test/fine_insertion_square_2022-02-26-test/processed'
    data_root = '/home/hcis/YongZhe/PDM/PDM_dataset_inference/Arrow_fine_inference/processed'
    ...
    for key, value in tqdm(data.items()):
        ...
        # trimesh = o3d.geometry.TriangleMesh.create_coordinate_frame(size=1)   
    ...
    print("loss: ", sum(loss_)/len(loss_))
